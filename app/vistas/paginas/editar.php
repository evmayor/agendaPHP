...
-->
	<?php if($datos['curso_tipo']=='1'): ?>
		<h2>Editar Curso</h2>
		<!--###################################-->
		<form action="<?php echo RUTA_URL; ?>/paginas/editar/<?php echo $datos['curso_id'] ?>" method='POST'>
...
-->		
			...
			<input type="submit" class="btn btn-success" name="Editar Curso" value="Guardar Cambios">
		</form>
